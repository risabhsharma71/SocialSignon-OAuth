...
module.exports = function(passport) {
    ...
    console.log("facebook details================================================>",profile)
...
passport.use("google-alt",new GoogleStrategy({
    ...
    clientID        : configAuth.googleContactsAuth.clientID,
    clientSecret    : configAuth.googleContactsAuth.clientSecret,
    callbackURL     : configAuth.googleContactsAuth.callbackURL,
    passReqToCallback : true, // allows us to pass in the req from our route (lets us check if a user is logged in or not)
    scope:["email","profile","https://www.googleapis.com/auth/user.phonenumbers.read"]
},
function(req, token, refreshToken, profile, done) {
 console.log("token from contacts==================>",profile)
    // asynchronous
    process.nextTick(function() {
    ...
    //Stocktwits//============================
    //======================================================================================================//
    var StockTwitsStrategy1 = configAuth.stocktwits;
    passport.use(new StockTwitsStrategy(StockTwitsStrategy1,
